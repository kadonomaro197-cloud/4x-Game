...
| ~~3 undefined minerals fault the ordnance build~~ ✅ **FIXED 2026-08-02** | `ordnance.json` | `gallicite`/`duranium`/`mercassium` were redirected to provided materials (electronics/steel/aluminium); every component cost now resolves. `BaseModIntegrityTests` is the gauge |
