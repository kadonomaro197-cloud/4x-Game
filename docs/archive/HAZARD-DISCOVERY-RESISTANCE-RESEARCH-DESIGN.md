...
**Read with:** `GameEngine/Hazards/CLAUDE.md` (the spine that's built), `docs/combat/DETECTION-DESIGN.md`, `docs/combat/INFORMATION-DELTA-DESIGN.md`, the Prime Directive + Cradle-to-Grave in the root `CLAUDE.md`.
