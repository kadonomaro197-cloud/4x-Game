...
| ↳ *AI design entry point* | see `docs/AI-BRAIN-BUILD-TRACKER.md` (hub; §4 socket verification) → `AI-PERSONALITY-IMPLEMENTATION-SPEC.md` (code-ready) + 6 more `AI-*.md` | 📝 DESIGN COMPLETE, 0% BUILT | n/a (design) | **Prereqs before any build:** ⚠ fix seat durability (`People/AdminSpaceProcessor.cs:36-46`, "paramount"); 2 NO-SOCKETs (fleet situational read; crisis seed) |
