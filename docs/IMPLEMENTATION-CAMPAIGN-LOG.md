...
> 4. **E12 slice 2** — ✅ FUEL refuel-on-recovery DONE (2026-08-19b, `DockTools.RefuelFromCarrier`); slice 2c (ORDNANCE-on-recovery + a base-mod carrier/parasite for playability) deferred. **E13 later** (organic feed + no-electrical-power bypass) — **PARKED on a developer decision** (feed = abstract cost vs real biomass drain? · Substrate must reach the assembler before a power-bypass is even possible).
