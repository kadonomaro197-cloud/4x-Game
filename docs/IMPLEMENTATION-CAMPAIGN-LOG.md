...
> - **NEXT:** weapons CI green → fan out doors 2-11 in file-disjoint batches (author in parallel, batch-commit, gate CI, fix reds) → then the buildable tails (DS-T1, D-planfn-A) + un-stale the E-env cell → park the developer-ruling items with plain-English questions.
>
