...
> **🧭 FRESH NEXT ACTION (2026-08-22e) — SLICE-2 DESIGNER FORM: the WEAPONS door HYBRID layout LANDED on the client (developer: "do the slice 2 designer form"). Compile-gated by `build-client`; runtime is the developer's local build. The other 10 doors follow the same pattern in follow-up slices.**
