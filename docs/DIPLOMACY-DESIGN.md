...
**Seated in the leader pipeline (2026-07-07 — the overt twin of the Spymaster).** The FM runs the same six-rung people pipeline as every leader (`docs/AI-SELF-PLAY-DESIGN.md`), and its org mirrors the espionage Director→station-chief→agents shape line-for-line:
