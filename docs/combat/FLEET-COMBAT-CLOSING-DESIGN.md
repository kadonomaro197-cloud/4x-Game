...
speed, detection, and doctrine decide who can hit whom** — without ever becoming an RTS. Read `docs/combat/COMBAT-DESIGN.md`
(the eleven-system master) and `docs/combat/WEAPONS-DESIGN.md` (the weapon triangle + dodge) first; this is the
