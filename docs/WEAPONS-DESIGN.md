...
> Governs by `UNIVERSAL-ASSEMBLY-DESIGN.md`: the essence emerges from the specs.
...
`GroundDamageMatrix`). This is the "shield" mechanism on the defence axis (`UNIVERSAL-ASSEMBLY-DESIGN.md` §2b) —
