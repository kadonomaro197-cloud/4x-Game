...
namespace Pulsar4X.GroundCombat
{
    ...
    /// docs/AUTO-RESOLVER-GROUND-TRUTH-2026-07-29.md §11, the north star: "one resolver, both domains").
    ///
    ...
    public static class GroundCombatant
    {
        ...
        /// <paramref name="mount"/>'s Attack/Mode/Range instead of the unit's collapsed values, AND (A2) its OWN
        /// Penetration / PerShotEnergy — so a unit with a rifle and a railgun cracks plate only with the railgun. A unit
        /// carrying exactly ONE weapon yields a mount whose Attack/Mode/Range/Penetration/PerShotEnergy equal the collapsed
        /// values, so this reproduces
        ...
        public static WeaponProfile ToWeaponProfile(GroundUnit unit, GroundWeaponMount mount, double hexPitch_m = NominalHexPitch_m)
        {
            ...
            return new WeaponProfile(mount.Attack, velocity, tracking, saturation, range_m, nature, delivery, mount.Penetration, mount.PerShotEnergy);
        }
