...
deterministic (the locked rule — *fast-forward must equal watch*; see `docs/combat/FLEET-COMBAT-CLOSING-DESIGN.md`). Today's
...
build plan + locked decisions are `docs/combat/FLEET-COMBAT-CLOSING-DESIGN.md`. Each phase is behind a **default-OFF flag**
