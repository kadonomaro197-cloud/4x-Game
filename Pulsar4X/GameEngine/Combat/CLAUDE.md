...
**The math (all in `CombatEngagement`, see `docs/WEAPONS-DESIGN.md`):**
...
hook. Design + connected systems: `docs/WEAPONS-DESIGN.md` → "Future depth — aggregate force
...
limits are exactly where the parked **aggregate force-condition** model plugs in (`docs/WEAPONS-DESIGN.md`
