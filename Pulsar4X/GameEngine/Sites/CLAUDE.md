...
| SE-3 | surface sites — locate ruins on a hex, the unit-worker path, Load/Land orders + hex landing, the guardian hook | 🔨 building (SE-3a done — the surface location record; SE-3b ground-worker next) |
