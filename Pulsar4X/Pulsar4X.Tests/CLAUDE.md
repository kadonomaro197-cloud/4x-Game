...
| &nbsp;&nbsp;`CombatStressLab` | **10 extreme weapon-design + fleet-scale stress sims**, assertions encode measured results: rate-of-fire (S01) and velocity (S03) each defeat evasion like saturation does; slow flak is useless (S02); nothing is untouchable (S04); alpha beats attrition (S05); 100v100 mirror is exactly even (S06); a swarm overwhelms a super-capital at a brutal ratio (S07,S10: 1 capital ≈ 25-50 fighters); doctrine x2 swings a fight ~2:1 (S08); dodge scales to fleets (S09). The quantified read on the HOT-damage calibration |
